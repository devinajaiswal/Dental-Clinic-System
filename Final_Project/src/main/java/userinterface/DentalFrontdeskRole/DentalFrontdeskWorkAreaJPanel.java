 ...
 * @author zhangchuanqi
 */
public class DentalFrontdeskWorkAreaJPanel extends javax.swing.JPanel {
     ...
     */
    public DentalFrontdeskWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise) {
        initComponents();
    ...
    private void initComponents() {
        ...
        buttonPersonalInfo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/conversation.png"))); // NOI18N
        buttonPersonalInfo.setText("Inquiries To Me");
        ...
        btnManageEnterprise.setIcon(new javax.swing.ImageIcon(getClass().getResource("/conversation.png"))); // NOI18N
        btnManageEnterprise.setText("Inquiries To Org");
        ...
        buttonAppointments.setIcon(new javax.swing.ImageIcon(getClass().getResource("/appointment.png"))); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(buttonAppointments, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void buttonPersonalInfoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonPersonalInfoActionPerformed
        ...
        DentalFrontDeskInquiriesForYouJPanel inquiryJpanel = new DentalFrontDeskInquiriesForYouJPanel(userProcessContainer, account, organization, enterprise);
    ...
    private void btnManageEnterpriseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManageEnterpriseActionPerformed
        customerContainer.removeAll();
        DentalFrontDeskInquiriesForOrgJPanel inquiryJpanel = new DentalFrontDeskInquiriesForOrgJPanel(userProcessContainer, account, organization, enterprise);
        customerContainer.add(inquiryJpanel);
        CardLayout layout = (CardLayout) customerContainer.getLayout();
        layout.next(customerContainer);
