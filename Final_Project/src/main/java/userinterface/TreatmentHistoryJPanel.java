 ...
 * @author raunak
 */
public class TreatmentHistoryJPanel extends javax.swing.JPanel {
    ...
    public TreatmentHistoryJPanel(String patientUsername) {
        initComponents();
    ...
    private void populateTable() {
        populateTable(data.TreatmentWorkRequestDAO.searchByPatient(patientUsername));
    }
